  ...
  return (
    ...
    <div className="fixed inset-0 z-[3000] flex items-end sm:items-center justify-center bg-ink/45 p-0 sm:p-4 backdrop-blur-[2px] animate-in fade-in duration-300">
      <div className="bg-white w-full h-[100dvh] sm:h-auto sm:rounded-md sm:max-w-2xl shadow-xl flex flex-col sm:max-h-[85vh] rounded-none overflow-hidden animate-in slide-in-from-bottom-4 sm:zoom-in duration-300">
        {/* Cabeçalho */}
        <div className="flex justify-between items-center p-4 sm:p-6 border-b border-line shrink-0 bg-canvas/50">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full flex items-center justify-center shadow-sm bg-brand-50 text-[#2C5282]">
          ...
          <button onClick={onFechar} className="text-muted hover:text-body hover:bg-canvas p-2 rounded-full transition-colors">
            <X className="w-5 h-5" />
          </button>
        </div>

        {/* Conteúdo com scroll */}
        <div className="flex-1 overflow-y-auto p-6 sm:p-8 custom-scrollbar text-body space-y-6">
          {isTermos ? (
            <>
              <section>
                <h4 className="text-base font-bold text-ink mb-2">1. Aceitação dos Termos</h4>
              ...
              <section>
                <h4 className="text-base font-bold text-ink mb-2">2. Cadastro, Análise e Veracidade dos Dados</h4>
              ...
              <section>
                <h4 className="text-base font-bold text-ink mb-2">3. Uso dos Serviços</h4>
                ...
                <ul className="list-disc pl-5 text-sm space-y-1 text-body">
              ...
              <section>
                <h4 className="text-base font-bold text-ink mb-2">4. Agendamentos e Cancelamentos</h4>
                <p className="text-sm leading-relaxed">
              ...
              <section>
                <h4 className="text-base font-bold text-ink mb-2">5. Propriedade Intelectual</h4>
                <p className="text-sm leading-relaxed">
            ...
            <>
              <section>
                <h4 className="text-base font-bold text-ink mb-2">1. Compromisso com a Privacidade</h4>
                <p className="text-sm leading-relaxed">
              ...
              <section>
                <h4 className="text-base font-bold text-ink mb-2">2. Coleta de Dados Clínicos e de Identificação</h4>
                <p className="text-sm leading-relaxed mb-2">
              ...
              <section>
                <h4 className="text-base font-bold text-ink mb-2">3. Uso das Informações e Processo de Análise</h4>
                <p className="text-sm leading-relaxed">
              ...
              <section>
                <h4 className="text-base font-bold text-ink mb-2">4. Inteligência Artificial e Análise Preditiva</h4>
                <p className="text-sm leading-relaxed">
              ...
              <section>
                <h4 className="text-base font-bold text-ink mb-2">5. Segurança dos Dados e Criptografia</h4>
                <p className="text-sm leading-relaxed">
              ...
              <section>
                <h4 className="text-base font-bold text-ink mb-2">6. Seus Direitos (LGPD)</h4>
                <p className="text-sm leading-relaxed">
        ...
        {/* Rodapé */}
        <div className="shrink-0 p-4 sm:p-6 border-t border-line flex justify-end bg-canvas/50">
          <button
            onClick={onFechar}
            className="py-2.5 px-6 font-bold text-sm rounded-xl transition-all shadow-sm active:scale-95 text-white w-full sm:w-auto bg-[#2C5282] hover:bg-[#152D5C] shadow-purple-200 cursor-pointer border-none"
          >
            Entendi
          </button>
        </div>
